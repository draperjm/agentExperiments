...
def run_extraction_test():
    ...
    doc_path = Path("/Code/experiments/agent 07/Data/A534927_ARP5495_RETIC.pdf")
    ...
    request = {
        "files": [
            {
                "filename": "A534927_ARP5495_RETIC.pdf",
                "filepath": None,
                "page_start": None,
                "page_end": None
            }
        ...
        "documents_folder": "/Code/experiments/agent 07/Data",
        "output_dir": "/Code/experiments/agent 07/OUTPUT"
    }
    ...
    try:
        ...
        logs_result = subprocess.run(
            ["docker", "logs", "agent07-document-extractor", "--tail", "100"],
            capture_output=True,
            text=True,
            timeout=10
        )
