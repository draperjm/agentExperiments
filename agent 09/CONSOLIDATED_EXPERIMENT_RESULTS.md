...
|---|---|---|---|---|---|
| Data Set 1 | ARP5495-106 | Asset Relocation, 2A Windsor Road, McGraths Hill | 14 (SLGT) | A534927_ARP5495_RETIC.pdf | Yes |
| Data Set 2 | ARP4983-84 | Hoxton Park FSC streetlights | 14 (SLGT) | D526458_ARP4983_RETIC_NOTES.pdf | Yes |
| Data Set 4 | NRL15205-85 | Pillars and pole substation | 6 (POLE/PILL/ASSM) | A524058_NRL15205_NOTES.pdf | Yes |
| Data Set 5 | NRL15237-86 | Poles and switchgear | 5 (POLE/ASSM/BBLV) | A526924_NRL15237_RETIC_NOTES.pdf | Yes |
| Data Set 6 | URS35318 (82&67) | Pillars, Hoxton Park FSC | 2–4 (ASSM/PILL) | A535774_URS35318_RETIC_NOTES.pdf | No |
...
| Data Set 6 | 10 | 63 | 93.3% | PASS | 10 (2 ASSM assets intermittently dropped; total_assets 50/50 split) |

### Step 7 Inconsistency Detail

| Data Set | Asset(s) | Field | Issue | Fix |
|---|---|---|---|---|
| Data Set 1 | SLGT00316953/4 | `status` | Cell value `X` returned as literal or interpreted (`Marked for Deletion`, `Flagged for Deletion`) | Normalize `X` → `Marked for Deletion` in prompt |
| Data Set 2 | 14 × SLGT | `serial_number` | Runs 5, 7, 8 return empty across all 14 assets — systematic column mapping miss | Add `serial_number` column alias |
| Data Set 2 | 14 × SLGT | `status` | Same 3-run dropout as serial_number | Same fix |
| Data Set 4 | POLE00985413 | `serial_number` | `PL985413` in 2/7 runs; empty in 5/7 | Add `serial_number` column alias for pole sheets |
| Data Set 5 | BBLV00037149 | `asset_type` | Run 6 returns sheet name (`SWITCHGEAR`) instead of cell value (`LV Busbar`) | Prompt: distinguish sheet context from cell value |
...
| Data Set 6 | ASSM00749529/30 | `asset_id`, `asset_type`, `description`, `location` | Both ASSM assets missing in 5/10 runs (alternating pattern) | Prompt: all rows with populated asset ID are valid records |
| Data Set 6 | (global) | `total_assets` | `4` in 5 runs, `2` in 5 runs — mirrors ASSM dropout | Same fix as above |
...
|---|---|---|---|---|---|
| SLGT00316949 | 316949 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316950 | 316950 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316951 | 316951 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316952 | 316952 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316955 | 316955 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316956 | 316956 | **found** | Small solid black filled circle | EXISTING POLE* | Page 1, lower-left, chunk 3/4 |
| SLGT00316953 | 316953 | not_found | — | — | — |
| SLGT00316954 | 316954 | not_found | — | — | — |
| SLGT00302884–302889 | 302884–302889 | not_found | — | — | — |
...
| Asset ID | Bare ID | Agent Status | Symbol | Label | Location |
|---|---|---|---|---|---|
| SLGT00302876 | 302876 | **found** | Circle with starburst spikes, hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5/8 |
| SLGT00302877 | 302877 | **found** | Circle with starburst spikes, hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5/8 |
| SLGT00302878 | 302878 | **found** | Circle with starburst spikes, hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5/8 |
| SLGT00302879–302889 | 302879–302889 | **found** | Small hollow open circle | NEW POLE | Page 2, upper-left, chunk 5/8 |

#### Data Set 4 (6 assets — poles and pillars)

| Asset ID | Bare ID | Type | Agent Status | Symbol | Label | Location |
|---|---|---|---|---|---|---|
| POLE00985413 | 985413 | Pole | **found** | Triangle inside a circle | Pole Substation - New | Page 1, lower-right, chunk 4/4 |
| PILL00400355 | 400355 | Pillar | **found** | Rectangle | Pillar - New Excavation location | Page 1, upper-left, chunk 1/4 |
| PILL00968214 | 968214 | Pillar | **found** | Rectangle | Pillar - New Excavation location | Page 1, upper-left, chunk 1/4 |
| ASSM00628168 | 628168 | Assembly | not_found | — | — | — |
| ASSM00628169 | 628169 | Assembly | not_found | — | — | — |
| ASSM00632923 | 632923 | Assembly | not_found | — | — | — |

#### Data Set 5 (5 assets — poles and switchgear)

| Asset ID | Bare ID | Type | Agent Status | Symbol | Label | Location |
|---|---|---|---|---|---|---|
| POLE01001157 | 1001157 | Pole | **found** | — | — | Page 1, lower-right, chunk 4/4 |
| POLE01001158 | 1001158 | Pole | **found** | — | — | Page 1, lower-right, chunk 4/4 |
| ASSM00717015 | 717015 | Assembly | not_found | — | — | — |
| ASSM00717016 | 717016 | Assembly | not_found | — | — | — |
| BBLV00037149 | 37149 | LV Busbar | not_found | — | — | — |
...
|---|---|---|---|---|
| SLGT00316949 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316950 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316951 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316952 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316955 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316956 | high | direct | EXISTING POLE* | Small solid black filled circle |
| SLGT00316953 | none | no_sfl | — | — |
| SLGT00316954 | none | no_sfl | — | — |
| SLGT00302884–302889 | none | no_sfl | — | — |
...
| Asset ID | match_confidence | match_method | legend_label | symbol_description |
|---|---|---|---|---|
| SLGT00302876–302878 | high | direct | NEW LANTERN | Circle with starburst spikes, hollow centre |
| SLGT00302879–302889 | high | direct | NEW POLE | Small hollow open circle |

#### Data Set 4

| Asset ID | match_confidence | match_method | legend_label | symbol_description |
|---|---|---|---|---|
| POLE00985413 | high | direct | Pole Substation - New | Triangle inside a circle |
| PILL00400355 | high | direct | Pillar - New Excavation location | Rectangle |
| PILL00968214 | high | direct | Pillar - New Excavation location | Rectangle |
| ASSM00628168 | none | no_sfl | — | — |
| ASSM00628169 | none | no_sfl | — | — |
| ASSM00632923 | none | no_sfl | — | — |

#### Data Set 5

| Asset ID | match_confidence | match_method | legend_label | symbol_description |
|---|---|---|---|---|
| POLE01001157 | high | direct | — | — |
| POLE01001158 | high | direct | — | — |
| ASSM00717015 | none | no_sfl | — | — |
| ASSM00717016 | none | no_sfl | — | — |
| BBLV00037149 | none | no_sfl | — | — |
...
- **Step 7 (spreadsheet)** is the least consistent step: serial number column mapping gaps (DS2, DS4) and ambiguous row-filtering rules (DS5 switchgear, DS6 ASSM assets) cause targeted dropouts. All issues have known fixes.
...
- **Match rates vary by asset type and drawing convention:** Assembly sub-components (ASSM prefix) are not individually numbered on site plans and are structurally not findable. Data Set 2 is the only project where all streetlight IDs appear directly on the drawing (100% match rate).
...
| ASSM pillar rows intermittently dropped | 7 | DS6 | Medium | Prompt: all rows with populated asset ID are valid records |
...
| SFL linkage path untested | 9 | All | High (unverified) | Run Step 9 after Step 7 with SFL extraction active; verify `sfl_lookup` path resolves ASSM assets |
