...
The Data Set 1 variance session returned `label: "EXISTING POLE"` with `symbol_description: "Small solid black filled circle"` for the 6 Windsor SLGT assets — **consistently across all 10 runs**. Earlier historical runs (Runs 2–6) returned `label: "NEW POLE"` with a small hollow open circle.
...
The 14 assets in this project are all streetlights (SLGT prefix). Their bare IDs do not generally appear on the drawing because streetlights are tagged with parent pole numbers (POLE numbers) in Endeavour Energy's drawing convention.

| Asset ID | Bare ID | Location | Status |
|---|---|---|---|
| SLGT00316949 | 316949 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00316950 | 316950 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00316951 | 316951 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00316952 | 316952 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00316953 | 316953 | Windsor FSC (deletion flag) | not_found all runs |
| SLGT00316954 | 316954 | Windsor FSC (deletion flag) | not_found all runs |
| SLGT00316955 | 316955 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00316956 | 316956 | Windsor FSC | **found** in 5/6 historical runs + all 10 variance runs |
| SLGT00302884 | 302884 | Hoxton Park FSC | not_found all runs |
| SLGT00302885 | 302885 | Hoxton Park FSC | not_found all runs |
| SLGT00302886 | 302886 | Hoxton Park FSC | not_found all runs |
| SLGT00302887 | 302887 | Hoxton Park FSC | not_found all runs |
| SLGT00302888 | 302888 | Hoxton Park FSC | not_found all runs |
| SLGT00302889 | 302889 | Hoxton Park FSC | not_found all runs |
...
|---|---|---|---|
| POLE01001157 | 1001157 | Poles | **found** — "Page 1, lower-right area, chunk 4 of 4" |
| POLE01001158 | 1001158 | Poles | **found** — "Page 1, lower-right area, chunk 4 of 4" |
| ASSM00717015 | 717015 | Poles (Assembly) | not_found |
| ASSM00717016 | 717016 | Poles (Assembly) | not_found |
...
| Metric | Value |
|---|---|
| Found | 2 (POLE01001157, POLE01001158) — identical all 10 runs |
| Not Found | 3 — identical all 10 runs |
| Consistency | 280/280 fields = **100% PASS** |

**Match rate: 2/5 (40%).**  
Assembly components (ASSM prefix) and secondary equipment (BBLV) are sub-components not individually numbered on the drawing. Only top-level pole structures receive distinct drawing numbers.
...
|---|---|---|---|---|
| POLE00985413 | 985413 | Poles | triangle inside a circle — "Pole Substation - New" | Chunk 4 of 4 |
| ASSM00628168 | 628168 | Poles (Assembly) | not_found | — |
| PILL00400355 | 400355 | Pillars | rectangle — "Pillar - New Excavation location" | Chunk 1 of 4 |
| PILL00968214 | 968214 | Pillars | rectangle — "Pillar - New Excavation location" | Chunk 1 of 4 |
| ASSM00628169 | 628169 | Pillars (Assembly) | not_found | — |
| ASSM00632923 | 632923 | Pillars (Assembly) | not_found | — |

**Variance session (10 runs, Exp_20260523_120446):**

| Asset | Status | Label | Symbol | Location | Consistency |
|---|---|---|---|---|---|
| POLE00985413 | found | Pole Substation - New | triangle inside a circle | Page 1, lower-right, chunk 4 of 4 | identical all 10 runs |
| PILL00400355 | found | Pillar - New Excavation location | rectangle | Page 1, upper-left, chunk 1 of 4 | identical all 10 runs |
| PILL00968214 | found | Pillar - New Excavation location | rectangle | Page 1, upper-left, chunk 1 of 4 | identical all 10 runs |
| ASSM00628168 | not_found | — | — | — | identical all 10 runs |
| ASSM00628169 | not_found | — | — | — | identical all 10 runs |
| ASSM00632923 | not_found | — | — | — | identical all 10 runs |
...
|---|---|---|---|---|
| SLGT00302876 | 302876 | Circle with starburst spikes and hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5 of 8 |
| SLGT00302877 | 302877 | Circle with starburst spikes and hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5 of 8 |
| SLGT00302878 | 302878 | Circle with starburst spikes and hollow centre | NEW LANTERN | Page 2, upper-left, chunk 5 of 8 |
| SLGT00302879–302889 | 302879–302889 | Small hollow open circle | NEW POLE | Page 2, upper-left, chunk 5 of 8 |
...
| **New SFL-based** | Run 6, NRL/ARP4983, all variance sessions | EnrichedAssets | Two-phase: direct match for Step 8 found assets; SFL linkage for not-found assets. Introduces `match_method` field. No inference — if SFL not available, confidence stays "none" |
...
|---|---|---|---|
| high | direct | 2 | POLE01001157, POLE01001158 |
| none | no_sfl | 3 | ASSM00717015, ASSM00717016, BBLV00037149 |
...
| match_confidence | match_method | Count | Assets |
|---|---|---|---|
| high | direct | 3 | POLE00985413 (Pole Substation - New), PILL00400355, PILL00968214 |
| none | no_sfl | 3 | ASSM00628168, ASSM00628169, ASSM00632923 |
...
- **Asset type determines findability:** Only assets with distinct drawing numbers (poles, pillars, full streetlight assets with their own IDs on Data Set 2) are found directly. Assembly sub-components (ASSM prefix) and secondary equipment types are not individually visible on site plan drawings.
...
- **SFL dependency:** The new Step 9's power depends on Step 7 extracting `superior_functional_location`. Once Step 7 extracts SFL correctly, the Hoxton Park SLGT assets (302884–302889) in Data Set 1 should resolve via `sfl_lookup` or `sfl_chunk_search` through their parent POLE numbers.
