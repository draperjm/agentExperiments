...
_MANAGED_SERVICES = [
    {"name": "agent08-responder",          "label": "Responder",         "health": "http://responder:8000/tasks"},
    {"name": "agent08-orchestrator",       "label": "Orchestrator",      "health": None},
    {"name": "agent08-document-reviewer",  "label": "Document Reviewer", "health": "http://document-reviewer:8089/health"},
    {"name": "agent08-document-extractor", "label": "Document Extractor","health": "http://document-extractor:8090/health"},
    {"name": "agent08-step-validator",     "label": "Step Validator",    "health": "http://step-validator:8088/health"},
    {"name": "agent08-document-chunker",   "label": "Document Chunker",  "health": "http://document-chunker:8091/health"},
    {"name": "agent08-frontend",           "label": "Frontend",          "health": None},
]
